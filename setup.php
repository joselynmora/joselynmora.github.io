...
{ 
  ...
  { 
    $result = "SELECT noControl,password FROM alumno
      WHERE noControl='$user' AND password='$pass'"; 
    ...
    { 
      ...
      ?>
      <h3 class="ok">¡Inicio de sesión exitoso!</h3>
      <?php  
     }
   }
 }
...
<body>
	...
	<form method="post">
    	<h1>Inicie sesión</h1>
    	<input type="text" name='user' value='$user' placeholder="No Control">
    	<input type="password" name='pass' value='$pass' placeholder="Password">
    	<input type="submit" name="register">
    	<h6>¿No te has registrado?,<a href="http://localhost/Proyecto_BD/index.php">registráte aquí</a></h6>
